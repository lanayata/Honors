...
Following this acclimatisation time it was expected that users could accurately
...
\begin{figure}[H]
  \centering
      \includegraphics[width=0.8\textwidth]{images/environmentPhoto.pdf}
...
\begin{figure}[H]
  \centering
      \includegraphics[width=1\textwidth]{images/pilotResult.pdf}
